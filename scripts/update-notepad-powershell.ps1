...
<!--	<Styles>
    <WordsStyle name="DEFAULT" styleID="11" fgColor="000000" bgColor="FFFFFF" fontName="" fontStyle="0" fontSize="" />
		<WordsStyle name="KEYWORD1" styleID="5" fgColor="FF6600" bgColor="FFFFFF" fontName="" fontStyle="1" fontSize="" />
		<WordsStyle name="KEYWORD2" styleID="6" fgColor="0080C0" bgColor="FFFFFF" fontName="" fontStyle="0" fontSize="" />
		<WordsStyle name="KEYWORD3" styleID="7" fgColor="CEDF99" bgColor="FFFFFF" fontName="" fontStyle="0" fontSize="" />
		<WordsStyle name="KEYWORD4" styleID="8" fgColor="000040" bgColor="FFFFFF" fontName="" fontStyle="0" fontSize="" />
		...
		<WordsStyle name="OPERATOR" styleID="10" fgColor="FFCC00" bgColor="FFFFFF" fontName="" fontStyle="0" fontSize="" />
		<WordsStyle name="DELIMINER1" styleID="14" fgColor="66FF00" bgColor="FFFFFF" fontName="" fontStyle="0" fontSize="" />
...
$keywordtext = "<?xml version=`"1.0`" encoding=`"Windows-1252`" ?>`n<NotepadPlus>`n<AutoComplete language=`"PowerShell`">`n"  
